//================================================================================
//
//    クック・トランス金属反射モデルシェーダー
//    Author : Araki Kai                                作成日 : 2018/07/29
//
//================================================================================
...
// クック・トランス金属反射
	...
	// フレネル反射係数
	const float refraction = 10.0f;		// 屈折率(これを上げると中心からの色の領域が広くなる)
	...
	// 金属の色
	float4 metal_color = {0.9f, 0.8f, 0.3f, 1.0f};

	input.color_ += metal_color * max(0, (beckmann_distribution_function * geometric_decay_rate * fresnel) / dot_normal_eye);
