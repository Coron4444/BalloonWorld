...
void StageManager::CreateStage()
{
	...
	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(30.0f, 280.0f, -10.0f));
	scaffold_->setScale(Vec3(10.0f, 10.0f, 10.0f));
	scaffold_->setColor(XColor4(1.0f, 1.0f, 3.0f, 1.0f));
	scaffold_->setScore(10);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(-60.0f, 50.0f, -70.0f));
	scaffold_->setScale(Vec3(10.0f, 10.0f, 10.0f));
	scaffold_->setColor(XColor4(1.0f, 1.0f, 3.0f, 1.0f));
	scaffold_->setScore(10);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(-20.0f, 50.0f, 60.0f));
	scaffold_->setScale(Vec3(10.0f, 10.0f, 10.0f));
	scaffold_->setColor(XColor4(1.0f, 1.0f, 3.0f, 1.0f));
	scaffold_->setScore(10);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(-90.0f, 135.0f, -64.0f));
	scaffold_->setScale(Vec3(10.0f, 30.0f, 10.0f));
	scaffold_->setColor(XColor4(1.0f, 1.0f, 3.0f, 1.0f));
	scaffold_->setScore(10);
	...
	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(60.0f, 100.0f, -40.0f));
	scaffold_->setScale(Vec3(60.0f, 5.0f, 3.0f));
	scaffold_->setColor(XColor4(0.0f, 0.0f, 1.0f, 1.0f));
	scaffold_->setScore(30);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(10.0f, 200.0f, -40.0f));
	scaffold_->setScale(Vec3(5.0f, 10.0f, 5.0f));
	scaffold_->setColor(XColor4(0.0f, 0.5f, 1.0f, 1.0f));
	scaffold_->setScore(30);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(30.0f, 170.0f, -10.0f));
	scaffold_->setScale(Vec3(5.0f, 10.0f, 5.0f));
	scaffold_->setColor(XColor4(0.0f, 0.5f, 1.0f, 1.0f));
	scaffold_->setScore(30);

	scaffold_ = scaffold_factory.Create();
	scaffold_->setPosition(Vec3(80.0f, 30.0f, -40.0f));
	scaffold_->setScale(Vec3(5.0f, 10.0f, 5.0f));
	scaffold_->setColor(XColor4(0.0f, 0.5f, 1.0f, 1.0f));
	scaffold_->setScore(30);
	...
	{
		scaffold_ = scaffold_factory.Create();
		scaffold_->setPosition(Vec3(Random::getpInstance()->getFloat(-hani, hani),
									Random::getpInstance()->getFloat(10.0f, 270.0f),
									Random::getpInstance()->getFloat(-hani, hani)));
		scaffold_->setScale(Vec3(Random::getpInstance()->getFloat(1.0f, 30.0f), 
	...
	needle_ = needle_factory.Create(new NeedleState_Loop());
	needle_->setPosition(Vec3(50.0f, 200.0f, -30.0f));
	needle_->setScale(5.0f);

	needle_ = needle_factory.Create(new NeedleState_Loop());
	needle_->setPosition(Vec3(10.0f, 150.0f, 30.0f));
	needle_->setScale(3.0f);

	needle_ = needle_factory.Create(new NeedleState_Loop());
	needle_->setPosition(Vec3(-100.0f, 100.0f, 60.0f));
	needle_->setScale(5.0f);

	needle_ = needle_factory.Create(new NeedleState_Loop());
	needle_->setPosition(Vec3(70.0f, 50.0f, 80.0f));
	needle_->setScale(3.0f);

	for (int i = 0; i < object_num; i++)
	{
		needle_ = needle_factory.Create(new NeedleState_Loop());
		needle_->setPosition(Vec3(Random::getpInstance()->getFloat(-hani, hani),
								  Random::getpInstance()->getFloat(10.0f, 270.0f),
								  Random::getpInstance()->getFloat(-hani, hani)));
