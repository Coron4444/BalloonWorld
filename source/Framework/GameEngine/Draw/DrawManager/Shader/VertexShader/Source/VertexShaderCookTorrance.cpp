//================================================================================
//!	@file	 VertexShaderCookTorrance.cpp
...
// 定数定義
//****************************************
const char* VertexShaderCookTorrance::PATH = "resource/HLSL/Effect/VertexShader/CookTorrance.vsh";
...
// 関数定義
//****************************************
void VertexShaderCookTorrance::Init()
{
	// デバイス初期化
	InitDevice();
...
void VertexShaderCookTorrance::Uninit()
{
	// シェーダーの解放
	ReleaseVertexShader();
}
...
void VertexShaderCookTorrance::ObjectSetting(DrawBase* draw, Camera* camera,
...
// +固有設定関数
//--------------------------------------------------
void VertexShaderCookTorrance::MeshSetting(DrawBase* draw, Camera* camera,
