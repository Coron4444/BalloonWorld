//================================================================================
//!	@file	 VertexShaderBlinnPhong.cpp
//!	@brief	 ブリン・フォンの鏡面反射頂点シェーダーClass
//! @details 
...
// 定数定義
//****************************************
const char* VertexShaderBlinnPhong::PATH = "resource/HLSL/Effect/VertexShader/BlinnPhong.vsh";
...
// 関数定義
//****************************************
void VertexShaderBlinnPhong::Init()
{
	// デバイス初期化
	InitDevice();
...
void VertexShaderBlinnPhong::Uninit()
{
	// シェーダーの解放
	ReleaseVertexShader();
}
...
void VertexShaderBlinnPhong::ObjectSetting(DrawBase* draw, Camera* camera,
...
// +固有設定関数
//--------------------------------------------------
void VertexShaderBlinnPhong::MeshSetting(DrawBase* draw, Camera* camera,
