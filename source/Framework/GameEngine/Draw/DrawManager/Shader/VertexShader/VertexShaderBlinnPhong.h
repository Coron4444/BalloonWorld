//================================================================================
//!	@file	 VertexShaderBlinnPhong.h
//!	@brief	 ブリン・フォンの鏡面反射頂点シェーダーClass
//! @details 
//!	@author  Kai Araki									@date 2019/02/18
//================================================================================
#ifndef	_VERTEX_SHADER_BLINN_PHONG_H_
#define _VERTEX_SHADER_BLINN_PHONG_H_
...
//! @brief   ブリン・フォンの鏡面反射頂点シェーダーClass
//!
//! @details ブリン・フォンの鏡面反射の頂点シェーダーClass
//************************************************************
class VertexShaderBlinnPhong : public VertexShaderNull
{
//====================
// 定数
//====================
