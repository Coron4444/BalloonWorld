//================================================================================
//!	@file	 PixelShaderBlinnPhong.cpp
...
// インクルード文
//****************************************
#include "../PixelShaderBlinnPhong.h"
...
// 定数定義
//****************************************
const char* PixelShaderBlinnPhong::PATH = "resource/HLSL/Effect/PixelShader/BlinnPhong.psh";
...
// 関数定義
//****************************************
void PixelShaderBlinnPhong::Init()
{
	// デバイス初期化
	InitDevice();
...
void PixelShaderBlinnPhong::Uninit()
{
	// シェーダーの解放
	ReleasePixelShader();
}
...
void PixelShaderBlinnPhong::ObjectSetting(DrawBase* draw, Camera* camera,
...
void PixelShaderBlinnPhong::MeshSetting(DrawBase* draw, Camera* camera,
